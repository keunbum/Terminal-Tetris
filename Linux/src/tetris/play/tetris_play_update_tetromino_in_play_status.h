...
#define TETRIS_PLAY_TETROMINO_IN_PLAY_INIT_POS_X (TETRIS_PLAY_SKYLINE_POS_X - 0)
#define TETRIS_PLAY_TETROMINO_IN_PLAY_INIT_POS_Y (TETRIS_PLAY_MATRIX_POS_Y + 1 + TETRIS_PLAY_MATRIX_INNER_WIDTH / 2 - 2)
