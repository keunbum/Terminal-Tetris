...
#define TETRIS_PLAY_TETROMINO_IN_PLAY_INIT_POS_X (TETRIS_PLAY_SKYLINE_POS_X)
#define TETRIS_PLAY_TETROMINO_IN_PLAY_INIT_POS_Y (TETRIS_PLAY_MATRIX_POS_Y + TETRIS_PLAY_MATRIX_WIDTH / 2 - 1)
