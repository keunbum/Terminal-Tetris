...
#define TETRIS_PLAY_TETROMINO_INIT_POS_X (-5.0)
#define TETRIS_PLAY_TETROMINO_INIT_POS_Y (TETRIS_PLAY_BOARD_WIDTH / 2.0)
...
// 1초마다 내려가는 칸 수.
#define NEW_TETRIS_PLAY_TETROMINO_INIT_VELOCITY (TETRIS_PLAY_TETROMINO_UNIT_DISTANCE) * 20.0
