...
#define TETRIS_PLAY_UNIT_VELOCITY (0.05)
...
// tetromino_status_t try_tetromino_next_status(const board_t* restrict board, const tetromino_t* restrict tetro, pos_int_t npos, dir_t ndir);
