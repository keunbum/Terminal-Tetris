...
#define TETRIS_PLAY_TETROMINO_INIT_POS_Y (TETRIS_PLAY_BOARD_POS_Y + TETRIS_PLAY_BOARD_WIDTH / 2 + 0)
#define TETRIS_PLAY_TETROMINO_INIT_POS_X_WPRINT (TETRIS_PLAY_TETROMINO_INIT_POS_X)
#define TETRIS_PLAY_TETROMINO_INIT_POS_Y_WPRINT (2 * TETRIS_PLAY_TETROMINO_INIT_POS_Y + 1)

#define TETRIS_PLAY_TETROMINO_POS_X_MIN (TETRIS_PLAY_TETROMINO_INIT_POS_X)
#define TETRIS_PLAY_TETROMINO_POS_X_MAX (TETRIS_PLAY_BOARD_POS_X + TETRIS_PLAY_BOARD_HEIGHT - 1)
#define TETRIS_PLAY_TETROMINO_POS_Y_MIN (TETRIS_PLAY_TETROMINO_INIT_POS_Y)
#define TETRIS_PLAY_TETROMINO_POS_Y_MAX (TETRIS_PLAY_TETROMINO_INIT_POS_Y + TETRIS_PLAY_BOARD_WIDTH - 1)
...
#define TETRIS_PLAY_TETROMINO_INIT_VELOCITY (TETRIS_PLAY_TETROMINO_UNIT_DISTANCE * 10.0)
