...
그리고 게임 오버 시에도 따로 메시지를 띄워서 한 판 더 할 것인지, 아님 게임 선택 화면으로 돌아갈 것인지 묻게끔 구현해야 하는데 그러지 못했다.)

    <img src = ../img/%EA%B2%8C%EC%9E%84_%EB%A1%9C%EC%A7%81_1.png width="80%" height="80%">



- 이제 이를 프로세스/스레드 관점에서 다시 봐 보자.
